...
<Box my={"4"}>
<FormLabel htmmlFor="message" children="Message"/>

<Textarea require id="message" value ={message} onChange={(e) => setMessage(e.target.value)}
...
<Box my="4"> Request for a course? <Link to="/request">  <Button colorScheme={"yellow"} variant="link"> Click </Button> {" "}
       here
      </Link>
      </Box>
